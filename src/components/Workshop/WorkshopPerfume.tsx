...
import img1 from '../../assets/workshop_perfume_1.jpg';
import img2 from '../../assets/workshop_perfume_2.jpg';
import img3 from '../../assets/workshop_perfume_3.jpg';
import img4 from '../../assets/workshop_perfume_4.jpg';
import img5 from '../../assets/workshop_perfume_5.jpg';

const perfumeImages = [img1, img2, img3, img4, img5];

const WorkshopPerfume = () => {
  return (
          ...
          <div className="md:w-1/2 space-y-8 text-center">
            ...
            <div className="space-y-6">
              <p className="text-xl text-[#23231f] leading-relaxed text-start md:pl-16">
                Blend your own signature scent using premium oils.<br />
                Perfect for beginners or scent enthusiasts<br />
                Create a perfume that tells your story
              </p>
              ...
              <ul className="space-y-3 text-lg md:pl-24 text-black font-semibold">
                <li className="flex items-center gap-3">
                  ...
                  <span>Price: $69(30ml)/$79(50ml)</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#23231f] inline-block"></span>
...
export default WorkshopPerfume;
